...
int inputNum = 0;
  while(inputNum != 3){
      ...
      public void shoppy() {
      	System.out.println("This is the Pomeshop! What would you like to do?");
      	System.out.println();
      	System.out.println("1. Adopt a Pomenon to add to your team! \n 2. Buy beans to buff your team! Beans can only be consumed once \n3. Buy PMs to teach your pomenons new moves! Make sure to apply the right TM type to your pomenon, or you'll waste your money.");
      	int input = 0;
        Scanner in = new Scanner(System.in);
    ...
    public void heal() {
      System.out.println("Welcome to the Pomclinic!");
